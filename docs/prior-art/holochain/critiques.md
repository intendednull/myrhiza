...
- *HN 32604428* (2022) — captures the prevailing skeptic line: "Store things cheaply, without blockchains or servers, so where is it stored? No infrastructure, so who is paying for it?" Plus the marketing critique: "Their speak around doesn't make them different, they are still crypto based, have a token, and spray buzzwords everywhere."
