...
- **Three Vats / Three Networks demo** — the canonical OCapN demonstration class: three Goblins vats (e.g. "Server A", "Server B", "Carol") communicating seamlessly across three different network substrates, illustrating that OCapN's security and semantics are preserved across heterogeneous netlayers. Most prominently shown in the September 2025 Shepherd × Goblins fleet-orchestration demo.
