...
| License (per repo, verified) | go-libp2p: **MIT**; rust-libp2p: **MIT** (every crate); js-libp2p: **Apache-2.0 OR MIT** (dual); nim-libp2p: **Apache-2.0 OR MIT** (dual); cpp-libp2p: **Apache-2.0 OR MIT** (dual); jvm-libp2p: **MIT + Apache-2.0** (Permissive License Stack); py-libp2p: **MIT/Apache-2.0** |
