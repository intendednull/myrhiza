...
- Predecessor: **B-13 kernel-mediated authoring** (the produce half; spec `2026-06-03-b-13-kernel-mediated-authoring-design.md` lands with the B-13 PR — cross-branch reference, see §2.1 sequencing).
